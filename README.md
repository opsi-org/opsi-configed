...
```
cd existing_repo
git remote add origin https://gitlab.uib.gmbh/otto/configed-ausprobieren.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.uib.gmbh/otto/configed-ausprobieren/-/settings/integrations)
