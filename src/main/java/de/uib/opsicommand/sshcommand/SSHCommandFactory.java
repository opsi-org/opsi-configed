...
public class SSHCommandFactory
{
	...
	public static final String CONNECTION_NOT_ALLOWED = configed.getResourceValue("SSHConnection.CONNECTION_NOT_ALLOWED");
	...
	**/
	...
	public boolean isSSHCommandEqualSavedCommand(SSHCommand_Template command)
	{
		if (list_knownMenus.contains(command.getMenuText()))
		{
			...
			{
				logging.info(this," isSSHCommandEqualSavedCommand getSSHCommandByMenu( command.getMenuText() ) is null ");
				return false;
			}	
