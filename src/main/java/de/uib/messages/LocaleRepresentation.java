...
public class LocaleRepresentation //a String separated by '='
{
  ...
  public LocaleRepresentation(String name) throws Exception {
    if (name == null) throw new Exception(
      "LocaleRepresentation name must not be null"
    );
  ...
  public LocaleRepresentation(String name, String iconName) throws Exception {
    this(name);
    if (iconName != null) value = value + "=" + iconName;
  }

  public String getName() {
    int pos = value.indexOf('=');
    if (pos > -1) return value.substring(0, pos);
