			...
			implements DocumentListener, MouseListener, MouseMotionListener
{
	...
	protected void initFEditText()
	{
		...
		*/
		...
		//HyperlinkListener hyperlinkListener = new ActivatedHyperlinkListener(textpane);
	...
	*/
	...
	public void changedUpdate(DocumentEvent e)
	{
		/*
		try{
			logging.info(this, "changedUpdate " + e.getDocument().getText(0, e.getDocument().getLength()));
	...
	public void insertUpdate(DocumentEvent e)
	{
		/*
		try{
			logging.info(this, "insertUpdate " + e.getDocument().getText(0, e.getDocument().getLength()));
		} catch( BadLocationException ex) {}
		*/
	...
	public void removeUpdate(DocumentEvent e)
	{
		/*
		try{
			logging.info(this, "removeUpdate, current text >>" + e.getDocument().getText(0, e.getDocument().getLength()) + "<<");
		} catch( BadLocationException ex) {}
		*/
	...
	public void setDataChanged(boolean b)
	{
		...
		try{
			...
			//logging.info(this, "editingStarted " + editingStarted + " current text " +  currentText);
		} catch( Exception ex) { logging.info(this, " setDataChanged " + b + " " + ex); }
	...
	private String getLineForPos( int charpos )
	{
		...
		{
			result = linesplits[i];
			//logging.info(this, "line " + i + " starting  with charpos "  + pos + " is " + result);
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		//logging.info(this, " line clicked " + getLineForPos( textpane.getCaretPosition() ) );//+ "\n" + e);
	...
	public class LinkSearcher {
		...
		public int searchLinks()
		{
			...
			*/
			...
			//logging.info(this, "content length " + content.length() + " last index " + startIndex);
