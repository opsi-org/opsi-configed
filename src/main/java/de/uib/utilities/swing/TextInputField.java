	...
	public TextInputField(String initialValue, final Vector<String> proposedValues)
	{
		...
		comboField.addKeyListener(new KeyAdapter(){
			...
			public void keyPressed(KeyEvent e)
			{
				...
				//logging.info(this, " " + e.getKeyChar() +  " content until now >" + s + "< " + e);
				...
				if (s.length() == 0) 
				{
					...
					if (orderedBeginChars != null)
					{
						...
						{
							//logging.info(this, " orderedBeginChar compare ch " + ch + " to " + orderedBeginChars[i]);
						...
						//logging.info(this, " orderedBeginChar comparisons result " + ch  + " input was " + e.getKeyChar());
