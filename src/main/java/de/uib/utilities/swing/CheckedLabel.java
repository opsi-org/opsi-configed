 ...
 
{
	...
	protected void addInternalListeners()
	{
		...
		selectedLabel.addMouseListener(new GeneralMouseListener("selectedLabel"){
				...
				public void mouseClicked(MouseEvent e)
				{
					...
					if (changeStateAutonomously) ME.setSelected(false);
		...
		unselectedLabel.addMouseListener(new GeneralMouseListener("unselectedLabel"){
				...
				public void mouseClicked(MouseEvent e)
				{
					if (!isEnabled())
						return;
					super.mouseClicked(e);
					if (changeStateAutonomously) ME.setSelected(true);
					notifyActionListeners(
	...
	protected void setLayout()
	{
		...
		layout.setVerticalGroup( layout.createParallelGroup()
			...
			.addComponent(nullLabel, de.uib.utilities.Globals.lineHeight, de.uib.utilities.Globals.lineHeight, de.uib.utilities.Globals.lineHeight)
		);
		...
		layout.setHorizontalGroup( layout.createSequentialGroup()
			...
			.addComponent(nullLabel,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		);
	}
