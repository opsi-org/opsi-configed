...
{
	public static RunningInstances<JFrame> runningInstances 
		= new RunningInstances(JFrame.class, "edit panel dialog" );
	...
	protected boolean leaveChecked()
	{
		...
		if ( innerPanel instanceof PanelGenEditTable )
		{
			...
			if (editPanel.isDataChanged())
			{
				...
				{
					case  JOptionPane.YES_OPTION : editPanel.commit(); result = true; break;
					case JOptionPane.NO_OPTION : editPanel.cancel(); result = true; break;
