...
public class FEditObject extends javax.swing.JDialog implements ActionListener, KeyListener, DocumentListener {
	...
	protected void createComponents() {
		...
		buttonCommit.setPreferredSize(new Dimension(buttonWidth, de.uib.utilities.Globals.BUTTON_HEIGHT));
		...
		buttonCancel.setPreferredSize(new Dimension(buttonWidth, de.uib.utilities.Globals.BUTTON_HEIGHT));
		...
		buttonAdd.setPreferredSize(new Dimension(buttonWidth, de.uib.utilities.Globals.BUTTON_HEIGHT));
		buttonAdd.setVisible(false);

		extraField = new JTextField("");
		extraField.setPreferredSize(
				new Dimension(de.uib.utilities.Globals.BUTTON_WIDTH, de.uib.utilities.Globals.LINE_HEIGHT));
