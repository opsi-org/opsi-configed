	...
	, ActionListener
{
	...
	protected void init()
	{
		...
		*/
		...
		popupMarkHits.setText(configed.getResourceValue("SearchPane.popup.markall") );//"JTableSelectionPanel.markall")  + " ( F5 ) ");
		...
		layoutTopPane.setHorizontalGroup(
			layoutTopPane.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layoutTopPane.createSequentialGroup()
					...
					.addGap(Globals.minGapSize,Globals.minGapSize,Globals.minGapSize)
					.addComponent(buttonMarkAll, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,GroupLayout.PREFERRED_SIZE)
					.addGap(Globals.minGapSize,Globals.minGapSize,Globals.minGapSize)
					.addComponent(buttonInvertSelection, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,GroupLayout.PREFERRED_SIZE)
	...
	*/
	...
	protected int findViewRowFromValue(final int startviewrow, Object value, Set colIndices, TablesearchPane.SearchMode searchMode)
	{
	...
	*/
	...
	private void searchTheRow(int startrow, boolean addSelection)
	{
		...
		*/
		...
		{
			//case 0 :; 
			case 0 : searchMode = TablesearchPane.SearchMode.FULL_TEXT_SEARCHING_WITH_ALTERNATIVES; break;
			case 1 : searchMode = TablesearchPane.SearchMode.FULL_TEXT_SEARCHING_ONE_STRING; break;
			case 2 : searchMode = TablesearchPane.SearchMode.START_TEXT_SEARCHING; break;
			case 3 : searchMode = TablesearchPane.SearchMode.REGEX_SEARCHING; break;
		}
	...
	{
		//logging.info(this, "changedUpdate fieldSearch.getText().length() > 0   "  + (fieldSearch.getText().length() > 0 ) );
