...
// has to be String)
{
	...
	public MapSource(Vector<String> columnNames, Vector<String> classNames, Map<String, 
		Map> table, boolean rowCounting)
	{
	...
	protected void fetchData()
	{
		...
		for (String key : table.keySet())
		{
			...
			for (int i = 0; i < columnNames.size(); i++)
			{
				...
				if (key.startsWith("A") )
						logging.debug(this, "fetchData for A-key " + key + " col  " + columnNames.get(i) + " index " + i + " val " + ob);
				...
				else
				{
					...
					{
						logging.debug(this,  "fetchData row " + mRow + " no value in column  " +  columnNames.get(i) + " supplement by null");
					...
					else 
					{
						...
						else
						{
							if (class2defaultValue.get(className) != null)
							{
								...
								//logging.info(this, "fetchData row " + mRow + " ob == null, setting default for " + className );
							}
