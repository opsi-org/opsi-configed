...
public class LicensingInfoTableCellRenderer extends DefaultTableCellRenderer
{
        ...
        boolean hasFocus, int row, int column) 
    {
        ...
        if(columnName != null && columnName.equals(configed.getResourceValue("LicensingInfo.modules")))
        {
            ...
            //jc = new JLabel("" + value, Globals.createImageIcon("images/info_i.png", ""), JLabel.LEADING);

            //jc.setIcon(Globals.createImageIcon("images/Apps-Help-Info-icon-sw.png", ""));
            
            /**
            JButton infoButton = new JButton ("" + value, Globals.createImageIcon("images/info_i.png", ""));
        ...
        /* 
        if(columnName != null && columnName.equals(configed.getResourceValue("LicensingInfo.info")))
        {
            jc.setText("");
        ...
        */
            ...
            )
        {
            ...
            if(!state.equals(LicensingInfoMap.STATE_UNLICENSED))
            {
                ...
                jc.setToolTipText("<html>" + "clients: " + value.toString() + "<br>" + "license ids: "+ licenses +  "</html>");
            }
            else
            ...
            if(columnName == latestChange)
            {
                ...
                if(state.equals(LicensingInfoMap.STATE_CLOSE_TO_LIMIT) )
                {
                    ...
                    jc.setToolTipText("<html>" +configed.getResourceValue("LicensingInfo.warning.close_to_limit") + "<br>" + "clients: " + value.toString() + "<br>" + "license ids: "+ licenses +  "</html>");
                ...
                else if(state.equals(LicensingInfoMap.STATE_OVER_LIMIT))
                {
                    ...
                    jc.setToolTipText("<html>" +configed.getResourceValue("LicensingInfo.warning.over_limit") + "<br>" + "clients: " + value.toString() + "<br>" + "license ids: "+ licenses +  "</html>");
                ...
                {
                    jc.setBackground(Globals.darkOrange);
                    jc.setToolTipText("<html>" +configed.getResourceValue("LicensingInfo.warning.days") + "<br>" + "clients: " + value.toString() + "<br>" + "license ids: "+ licenses +  "</html>");   
                }
            ...
            {
                String futureState = moduleToDateData.get(LicensingInfoMap.FUTURE_STATE).toString();
                if(futureState != null && futureState.equals(LicensingInfoMap.STATE_CLOSE_TO_LIMIT))
                {
                    jc.setBackground(Globals.darkOrange);
                    jc.setToolTipText("<html>" +configed.getResourceValue("LicensingInfo.warning.future.close_to_limit") + "<br>" + "clients: " + value.toString() + "<br>" + "license ids: "+ licenses +  "</html>");
                }
                else if(futureState != null && futureState.equals(LicensingInfoMap.STATE_OVER_LIMIT))
                {
                    jc.setBackground(Globals.darkOrange);
                    jc.setToolTipText("<html>" +configed.getResourceValue("LicensingInfo.warning.future.over_limit") + "<br>" + "clients: " + value.toString() + "<br>" + "license ids: "+ licenses +  "</html>");
                }
            }
            */
            ...
            try{
                    ...
                    )
                {
                    ...
                    String prevClientNum = datesMap.get(prevCol).get(rowName).get(LicensingInfoMap.CLIENT_NUMBER).toString();

                    if( !prevCol.equals(configed.getResourceValue("LicensingInfo.modules")) && clientNum != null && prevClientNum != null)
                    {
