...
public class SearchTargetModelFromTable implements SearchTargetModel
{
	...
	public void setRenderAsCurrentRow( int row )
	{
		...
		for (int i = 0; i < table.getColumnModel().getColumnCount(); i++)
		{
			...
			logging.info(this, "setRenderAsCurrentRow col cell renderer is " + col.getCellRenderer() );
	...
	public boolean isFiltered()
	{
		...
		//((de.uib.utilities.table.GenTableModel) table.getModel()).isFiltered(); does not work since we don't always have got a GenTableModel 
	}
