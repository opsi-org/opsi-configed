	...
	implements DataChangedSubject
{
	...
	private String getModifiedKey()
	{
		...
		{
			if (
				key.startsWith( de.uib.opsidatamodel.permission.UserConfig.CONFIGKEY_STR_USER ) 
				&& 
	...
	*/
	...
	public void removeEntryFromStoredMaps(String myKey)
	{
		if (storeData != null)
		{
			...
			logging.debug(this, "remove entry --  updateCollection: " + updateCollection + "  has size " + updateCollection.size());
			...
			// we can only have come to here in this case
			{
				...
				else
				{
					...
					if (writeData)
					{
						...
						//logging.info(this, "setting value, modifiedKey, rowModiTime, row: "
						//+  value + ", " + modifiedKey
						//+ ", " + rowModiTime + ", " + row);
	...
	*/
	...
	{
		//logging.info(this, "setValue key, value " + key + ", " + value);
