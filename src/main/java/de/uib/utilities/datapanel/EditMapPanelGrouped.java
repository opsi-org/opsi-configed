...
// works on a map of pairs of type String - List
{
	...
	private JTable createJTableForPDF(){
		...
		for ( String key : keys )
		{
			...
			//logging.info(this, "createJTableForPDF mapTableModel.getData().get(key) " + mapTableModel.getData().get(key));
			//logging.info(this, "createJTableForPDF mapTableModel.getData() " + mapTableModel.getData());
			//logging.info(this, "createJTableForPDF mapTableModel.getData() " + mapTableModel.getData().getClass());
			//logging.info(this, "createJTableForPDF mapTableModel.getData().get( key ) " + mapTableModel.getData().get(key).getClass());
			/*
	...
	*/
	...
	public void setEditableMap(Map<String, Object> visualdata, Map<String, ListCellOptions> optionsMap)
	{
		...
		if (visualdata != null)
		{
			//logging.info(this, " setEditableMap, visualdata keys " + visualdata.keySet());
