...
public class FEditStringList extends JDialog
	...
	protected JList<String> visibleList;

	private Object initialValue = "";

	private List<String> initiallySelected;
	...
	private void addSelectedValues(List<String> toSelect) {
		if (toSelect == null) {
			return;
		}

		ListModel<String> model = visibleList.getModel();
	...
	public void setSelectedValues(List<String> toSelect) {
	...
	protected void addElement(String element) {
		ListModel<String> limo = visibleList.getModel();
		if (limo instanceof DefaultListModel) {
			if (!((DefaultListModel<String>) limo).contains(element)) {
				((DefaultListModel<String>) limo).addElement(element);
