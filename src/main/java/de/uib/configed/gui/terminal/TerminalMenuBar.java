...
package de.uib.configed.gui.terminal;
...
public class TerminalMenuBar extends JMenuBar {
	...
	private JMenu createFileMenu() {
		...
		jMenuItemNewWindow.addActionListener(actionEvent -> frame.openNewWindow());
		...
		jMenuItemNewSession.addActionListener(actionEvent -> frame.openNewSession());
