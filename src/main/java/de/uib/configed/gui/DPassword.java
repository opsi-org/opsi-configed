...
public class DPassword extends JDialog //implements Runnable
{
	...
	JLabel jLabelLabelJavaVersion = new JLabel(
			configed.getResourceValue("DPassword.jdkVersionBased")
			);
	...
	public void stopWaitInfo()
{
	...
	*/
		...
		/*passwordField.addComponentListener(new java.awt.event.ComponentAdapter()
	{
		...
		JCheckBox checkCompression = new JCheckBox(configed.getResourceValue("DPassword.checkCompression") , de.uib.opsicommand.JSONthroughHTTP.compressTransmission);
		...
		JCheckBox checkTrySSH = new JCheckBox(configed.getResourceValue("DPassword.checkTrySSH") , de.uib.configed.configed.sshconnect_onstart );
		...
		gpl.setVerticalGroup(gpl.createSequentialGroup()
		                     ...
		                     .addGroup(gpl.createParallelGroup()
		                               .addComponent(jLabelLabelJavaVersion, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
		                               .addComponent(jLabelJavaVersion, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
		                              )
		                     //.addComponent(jLabelJavaVersion, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
		...
		gpl.setHorizontalGroup(gpl.createParallelGroup()
		                       ...
		                       .addGroup(gpl.createSequentialGroup()
		                                 ...
		                                 .addComponent(jLabelLabelJavaVersion, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
		                                 .addGap(Globals.hGapSize/2)
		                                 .addComponent(jLabelJavaVersion, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
		                                 .addGap(Globals.hGapSize, 40, Short.MAX_VALUE)
		                                )
	...
	static public PersistenceController producePersistenceController(String server)
{
	...
	*/
	...
	public void try_connecting()
	{
		...
		final Rectangle dim = de.uib.utilities.Globals.buildLocationOnDefaultDisplay(waitInfo.getSize().width, waitInfo.getSize().height,


		                      getSize().width + 80,
		                      getSize().height + 40
		                      //de.uib.utilities.Globals.smallFramesDistanceFromLeft, de.uib.utilities.Globals.smallFramesDistanceFromTop
		                                                                            );
		...
		*/
		...
		de.uib.opsicommand.sshcommand.SSHConnectionInfo.getInstance().setPassw(String.valueOf( passwordField.getPassword() ));
		de.uib.opsicommand.sshcommand.SSHConnectionInfo.getInstance().setHost((String)fieldHost.getSelectedItem());
	}
