...
public class CSVTemplateCreatorDialog extends FGeneralDialog
{
	...
	protected void allLayout()
	{
		...
		allLayout.setHorizontalGroup(allLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
			...
			.addGroup(allLayout.createSequentialGroup()
				.addGap(Globals.hGapSize/2, Globals.hGapSize, 2*Globals.hGapSize )
				.addComponent(southPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addGap(Globals.hGapSize/2, Globals.hGapSize, 2*Globals.hGapSize )
			)
		);
	}
	...
	private JPanel createSouthPanel()
	{
		...
		southLayout.setHorizontalGroup(southLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
			.addGroup(southLayout.createSequentialGroup()
				...
				.addComponent(jPanelButtonGrid, Globals.lineHeight, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize/2, Globals.hGapSize, Short.MAX_VALUE)
			)
			.addGroup(southLayout.createSequentialGroup()
		...
		southLayout.setVerticalGroup(southLayout.createSequentialGroup()
			...
			.addComponent(additionalPane,Globals.lineHeight, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	protected JPanel initPanel()
	{
        ...
        JLabel dataSelectionLabel = new JLabel(configed.getResourceValue("CSVTemplateCreatorDialog.dataSelectionLabel"));
        ...
        JLabel fieldSeparatorLabel = new JLabel(configed.getResourceValue("CSVTemplateCreatorDialog.fieldSeparatorLabel"));

		includeFormatHintOption = new JCheckBox(configed.getResourceValue("CSVTemplateCreatorDialog.includeFormatHintOption"));
        ...
        columnNames.forEach(header ->
        {
			...
			if (header.equals("hostname")) headerBox.setSelected(true);
			if (header.equals("selectedDomain")) headerBox.setSelected(true);
			if (header.equals("depotID")) headerBox.setSelected(true);
			if (header.equals("macaddress")) headerBox.setSelected(true);
        ...
        centerLayout.setHorizontalGroup(centerLayout.createParallelGroup()
			...
			.addGroup(centerLayout.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(includeFormatHintOption, Globals.buttonWidth, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.minVGapSize,Globals.minVGapSize,Globals.minVGapSize)
			)
            .addGroup(centerLayout.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
            ...
            .addGroup(centerLayout.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(tabsOption,Globals.buttonWidth,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(commaOption,Globals.buttonWidth,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(semicolonOption,Globals.buttonWidth,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(spaceOption,Globals.buttonWidth,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(otherOption,Globals.buttonWidth,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(otherSeparatorInput,Globals.buttonWidth,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.minVGapSize,Globals.minVGapSize,Globals.minVGapSize)
			)
			.addGroup(centerLayout.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
		...
		centerLayout.setVerticalGroup(centerLayout.createSequentialGroup()
            ...
            .addGroup(centerLayout.createParallelGroup(GroupLayout.Alignment.CENTER)
				...
				.addComponent(otherSeparatorInput, Globals.buttonHeight,Globals.buttonHeight,Globals.buttonHeight)
			)
			.addGap(Globals.vGapSize,Globals.vGapSize,Globals.vGapSize)
			.addGroup(centerLayout.createParallelGroup(GroupLayout.Alignment.CENTER)
				.addComponent(stringSeparatorLabel)
				.addComponent(stringSeparatorOptions, Globals.buttonHeight,Globals.buttonHeight,Globals.buttonHeight)
			)
			.addGap(Globals.vGapSize,Globals.vGapSize,Globals.vGapSize)
		);
