...
public class PanelSWMultiClientReport extends JPanel
{
	...
	protected void setupPanel()
	{
		...
		JLabel labelSwauditMultiClientReport1 = new JLabel(configed.getResourceValue("PanelSWMultiClientReport.title1"));
		labelSwauditMultiClientReport1.setFont(de.uib.utilities.Globals.defaultFontBig);
		
		
		JLabel labelSwauditMultiClientReport2 = new JLabel(configed.getResourceValue("PanelSWMultiClientReport.title2"));
		labelSwauditMultiClientReport2.setFont(de.uib.utilities.Globals.defaultFontBold);
		
		JLabel labelFilenamePrefix= new JLabel(configed.getResourceValue("PanelSWMultiClientReport.labelFilenamePrefix"));
		
		String filenamePrefix = configed.savedStates.saveSWauditExportFilePrefix.
				deserialize();
		...
		JLabel labelFilenameInformation= new JLabel(configed.getResourceValue("PanelSWMultiClientReport.labelFilenameInformation"));
		...
		JLabel labelExportDirectory = new JLabel(configed.getResourceValue("PanelSWMultiClientReport.labelExportDirectory"));
		exportDirectoryS = "";

		JButton buttonCallSelectExportDirectory = new JButton( "", de.uib.configed.Globals.createImageIcon("images/folder_16.png", "" ));
		buttonCallSelectExportDirectory.setSelectedIcon( de.uib.configed.Globals.createImageIcon("images/folder_16.png", "" ) );
		buttonCallSelectExportDirectory.setPreferredSize(de.uib.configed.Globals.graphicButtonDimension);
		buttonCallSelectExportDirectory.setToolTipText(configed.getResourceValue("PanelSWMultiClientReport.labelExportDirectory")) ;
		...
		glPreConfig.setVerticalGroup(glPreConfig.createSequentialGroup()
				 ...
				 .addGroup( glPreConfig.createParallelGroup( GroupLayout.Alignment.CENTER )
							...
							.addComponent(buttonCallSelectExportDirectory, Globals.buttonHeight, Globals.buttonHeight, Globals.buttonHeight)
				 ...
				 .addComponent( panelSelectExportType, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				 ...
				 .addGroup( glPreConfig.createParallelGroup( GroupLayout.Alignment.CENTER )
							.addComponent(labelFilenameInformation,  Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				 )
				 .addGap(Globals.vGapSize/2, Globals.vGapSize/2, Globals.vGapSize/2)
				 .addGroup( glPreConfig.createParallelGroup( GroupLayout.Alignment.CENTER )
				...
				.addGroup( glPreConfig.createParallelGroup( GroupLayout.Alignment.CENTER )
						...
						.addComponent(checkAskForOverwrite,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				 )
		...
		glPreConfig.setHorizontalGroup(glPreConfig.createParallelGroup()
			   ...
			   .addGroup( glPreConfig.createSequentialGroup()
						  ...
						  .addComponent(labelExportDirectory,  de.uib.configed.Globals.buttonWidth,  de.uib.configed.Globals.buttonWidth*2, de.uib.configed.Globals.buttonWidth*2)

						  .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
						  
						  .addComponent(buttonCallSelectExportDirectory,  Globals.graphicButtonWidth, Globals.graphicButtonWidth, Globals.graphicButtonWidth) 
						  .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
						  .addComponent(fieldExportDirectory, 40,  de.uib.configed.Globals.buttonWidth*2, Short.MAX_VALUE)
						  .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize)
						)
			   ...
			   .addGroup( glPreConfig.createSequentialGroup()
						  .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize)
						  .addComponent(labelFilenamePrefix,   de.uib.configed.Globals.buttonWidth,  de.uib.configed.Globals.buttonWidth*2, de.uib.configed.Globals.buttonWidth*2) 
						  
						  .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
						  
						  .addGap(Globals.graphicButtonWidth, Globals.graphicButtonWidth, Globals.graphicButtonWidth)
						  .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
						  .addComponent(fieldFilenamePrefix,  de.uib.configed.Globals.buttonWidth/2,  de.uib.configed.Globals.buttonWidth, Short.MAX_VALUE/2)
						  .addGap(20,  de.uib.configed.Globals.buttonWidth, Short.MAX_VALUE/2)
						  .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize)
						 )
			   .addGroup( glPreConfig.createSequentialGroup()
						  .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize)
						  .addComponent(labelFilenameInformation,   GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
						 )
			   .addGroup( glPreConfig.createSequentialGroup()
						  .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize)
						  .addComponent(checkWithMsUpdates,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup( glPreConfig.createSequentialGroup()
						  ...
						  .addComponent(checkAskForOverwrite,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
						  .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize )
						  .addComponent(labelAskForOverwrite,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
						  )
		...
		glGlobal.setVerticalGroup(glGlobal.createSequentialGroup()
		                          ...
		                          .addGroup( glGlobal.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                     .addComponent(labelSwauditMultiClientReport1,  Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
		                                   )
		                          .addGroup( glGlobal.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                     .addComponent(labelSwauditMultiClientReport2,  Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
		                                   )
		                          .addGap(Globals.vGapSize, Globals.vGapSize, Globals.vGapSize)

		                          .addComponent(subpanelPreConfig, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		glGlobal.setHorizontalGroup(glGlobal.createParallelGroup()
		                            ...
		                            .addGroup( glGlobal.createSequentialGroup()
		                                       .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize )
		                                       .addComponent(labelSwauditMultiClientReport1, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                       .addGap(Globals.hGapSize, Globals.hGapSize, Short.MAX_VALUE )
		                                     )
		                            
		                            .addGroup( glGlobal.createSequentialGroup()
		                                       .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize )
		                                       .addComponent(labelSwauditMultiClientReport2, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                       .addGap(Globals.hGapSize, Globals.hGapSize, Short.MAX_VALUE )
		                                     )
		                            .addGroup( glGlobal.createSequentialGroup()
		                                       .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize )
		                            ...
		                            .addGroup( glGlobal.createSequentialGroup()
		                            		 .addGap(2*Globals.hGapSize, 2*Globals.hGapSize, 2*Globals.hGapSize )
		                                      .addComponent(buttonStart,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                     )
		                            .addGap(3*Globals.hGapSize, 3*Globals.hGapSize, 3*Globals.hGapSize)
		                           );
	}
