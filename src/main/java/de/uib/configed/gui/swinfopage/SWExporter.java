...
/**
*  Abstract class to manage batch export of SWAudit data, subclasses implement the type of export
*/
public abstract class SWExporter
{
	...
	*/
	...
	public void addMissingArgs()
	{
		...
		if( user == null )
			user = de.uib.utilities.Globals.getCLIparam( "User (default: " + System.getProperty("user.name") + ") : " , false );
		if (user.equals(""))
