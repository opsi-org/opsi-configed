...
public class BooleanEqualsOperation extends AbstractSelectOperation {
	public BooleanEqualsOperation(AbstractSelectElement element) {
		super(element);
	}

	@Override
	public SelectData.DataType getDataType() {
		return SelectData.DataType.BOOLEAN_TYPE;
	}
