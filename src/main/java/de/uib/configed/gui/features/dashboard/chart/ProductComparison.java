...
package de.uib.configed.gui.features.dashboard.chart;
...
import de.uib.configed.gui.features.dashboard.DataChangeListener;
...
public class ProductComparison extends StackPane implements DataChangeListener {
	...
	public void display() {
		...
		productsNoDataText.setStyle("-fx-fill: " + ComponentStyler.getHexColor(UIManager.getColor("Label.foreground")));
	}
