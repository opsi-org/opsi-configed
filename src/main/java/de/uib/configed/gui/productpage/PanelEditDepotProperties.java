	...
	implements ListSelectionListener, ActionListener, MouseListener, KeyListener
{
	...
	protected void initComponents()
	{
		...
		layoutPanelDepots.setVerticalGroup(
			layoutPanelDepots.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(scrollpaneDepots, GroupLayout.Alignment.LEADING, 0, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
		...
		layoutPanelDepots.setHorizontalGroup(
			layoutPanelDepots.createSequentialGroup()
				...
				.addComponent(buttonSelectWithEqualProperties,  0, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	public void setDepotListData(java.util.List<String> depots, String selectedDepot, String productEdited)
	{
		...
		if (depots != null) logging.info(this, "setDepotListData for count depots " +depots.size()); 
		/*
		...
		else
		{
			...
			else
			{
				...
				for (int i = 1; i< depots.size(); i++)
				{
					...
					if (properties == null)
					{
						logging.info(this, "mergeProperties, product on depot has not properties " + productId + " on " + depots.get(i));
						continue;
					}
