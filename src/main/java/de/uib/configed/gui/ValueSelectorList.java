	...
	*/	
	...
	private void initComponents()
	{
		...
		*/
		...
		if (!multidepot) searchPane.setEnabled(false);
	...
	private void layouting()
	{
		...
		layout.setVerticalGroup( layout.createSequentialGroup()
			...
			.addGroup(  layout.createParallelGroup( GroupLayout.Alignment.CENTER )
				.addComponent(labelValue, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				// .addComponent(buttonSelectValuesWithEqualProperties,  GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				// .addComponent(buttonSelectValuesAll,  GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		layout.setHorizontalGroup( layout.createParallelGroup( GroupLayout.Alignment.CENTER )
			.addGroup(  layout.createSequentialGroup()
				...
				// .addGap(10)
				// .addComponent(buttonSelectValuesWithEqualProperties, Globals.squareButtonWidth, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				// .addComponent(buttonSelectValuesAll, Globals.squareButtonWidth, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				//.addComponent(buttonCommitChangedDepotSelection, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				//.addComponent(buttonCancelChangedDepotSelection, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(10, 10, 10)
				)
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() ==  buttonSelectValuesWithEqualProperties)
		{
			...
			if (valueList.getSelectedIndex() > -1)
			{
				...
				= persist.getAllDepotsWithIdenticalProductStock(depotSelected);
