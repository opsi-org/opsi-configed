...
public class IconButton extends JButton
{
	...
	* @param imagesForAnimatedWaiting the chain of images for animation when waiting
	...
	*/
	public void setWaitingState( boolean b )
	{
		...
		if (b)
		{
			...
			//must be constructed newly for each call according to the definition of SwingWorker
