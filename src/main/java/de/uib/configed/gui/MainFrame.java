...
import de.uib.configed.gui.swinfopage.*;
import de.uib.configed.gui.hostconfigs.*;
			...
			ComponentListener
{
	...
	public CombinedMenuItem combinedMenuItemCreatedColumn =
		new CombinedMenuItem(
			jCheckBoxMenuItem_showCreatedColumn,
			popupShowCreatedColumn
			);
		
	public CombinedMenuItem combinedMenuItemWANactiveColumn =
		new CombinedMenuItem(
			jCheckBoxMenuItem_showWANactiveColumn,
			popupShowWANactiveColumn
			);
	
	public CombinedMenuItem combinedMenuItemIPAddressColumn =
		new CombinedMenuItem(
			jCheckBoxMenuItem_showIPAddressColumn,
			popupShowIPAddressColumn
			);
	
	public CombinedMenuItem combinedMenuItemHardwareAddressColumn =
		new CombinedMenuItem(
			jCheckBoxMenuItem_showHardwareAddressColumn,
			popupShowHardwareAddressColumn
			);
	
	public CombinedMenuItem combinedMenuItemSessionInfoColumn =
		new CombinedMenuItem(
			jCheckBoxMenuItem_showSessionInfoColumn,
			popupShowSessionInfoColumn
			);
	
	public CombinedMenuItem combinedMenuItemInventoryNumberColumn =
		new CombinedMenuItem(
			jCheckBoxMenuItem_showInventoryNumberColumn,
			popupShowInventoryNumberColumn
			);
	
	public CombinedMenuItem combinedMenuItemUefiBootColumn = 
		new CombinedMenuItem(
			jCheckBoxMenuItem_showUefiBoot,
			popupShowUefiBoot
			);
		
	public CombinedMenuItem combinedMenuItemInstallByShutdownColumn = 
		new CombinedMenuItem(
			jCheckBoxMenuItem_showInstallByShutdown,
			popupShowInstallByShutdownColumn
			);
			
	public CombinedMenuItem combinedMenuItemDepotColumn = 
		new CombinedMenuItem(
	...
	*/
	...
	private void setupMenuClients()
	{
		...
		combinedMenuItemHardwareAddressColumn.show( main.host_displayFields.get( HostInfo.clientMacAddress_DISPLAY_FIELD_LABEL ) );
		...
		combinedMenuItemSessionInfoColumn.show( main.host_displayFields.get( HostInfo.clientSessionInfo_DISPLAY_FIELD_LABEL ));
		...
		combinedMenuItemInventoryNumberColumn.show( main.host_displayFields.get( HostInfo.clientInventoryNumber_DISPLAY_FIELD_LABEL ) );
		...
		jCheckBoxMenuItem_showInstallByShutdown.setText(configed.getResourceValue("MainFrame.jMenuShowInstallByShutdown"));
		combinedMenuItemUefiBootColumn.show( main.host_displayFields.get( HostInfo.clientInstallByShutdown_DISPLAY_FIELD_LABEL ));
		...
		*/
		...
		jMenuResetProductOnClientWithStates.setText( configed.getResourceValue("MainFrame.jMenuResetProductOnClientWithStates") );
		...
		jMenuResetProductOnClient.setText( configed.getResourceValue("MainFrame.jMenuResetProductOnClientWithoutStates") );
	...
	**/
	private void setupMenuServer()
	{
		...
		if (configed.sshconnect_onstart) factory.testConnection(connectionInfo.getUser(), connectionInfo.getHost());
		...
		*/
		...
		boolean commandsAreDeactivated = (
			UserConfig.getCurrentUserConfig() == null
			||
	...
	private void setupMenuGrouping()
	{
		...
		*/
		...
		jMenuClientselectionProductNotUptodate.setText( configed.getResourceValue("MainFrame.jMenuClientselectionFindClientsWithOtherProductVersion") );
		...
		jMenuClientselectionProductNotUptodateOrBroken.setText( configed.getResourceValue("MainFrame.jMenuClientselectionFindClientsWithOtherProductVersionOrUnknownState") );
	...
	private void setupIcons1()
	{
		...
		iconButtonSessionInfo = new IconButton(
		                            ...
		                            "images/system-users-query_over.png",
		                            waitingCircle,
		                             //new String[]{"images/system-users-query_waiting_full.png",    "images/system-users-query_waiting_half.png"}, 
		                            500,
	...
	*/
	...
	private void setupPopupMenuClientsTab()
	{
		...
		*/
		...
		combinedMenuItemInstallByShutdownColumn.show( main.host_displayFields.get( HostInfo.clientInstallByShutdown_DISPLAY_FIELD_LABEL ));
		...
		popupResetProductOnClientWithStates.setText( configed.getResourceValue("MainFrame.jMenuResetProductOnClientWithStates") );
		...
		popupResetProductOnClient.setText( configed.getResourceValue("MainFrame.jMenuResetProductOnClientWithoutStates") );
	...
	private void guiInit(JApplet appletHost)
	{
		...
		*/
		...
		layoutPanelTreeClientSelection.setHorizontalGroup(
		    ...
		    .addGroup(layoutPanelTreeClientSelection.createParallelGroup(GroupLayout.Alignment.LEADING)
		    	 	...
		    	 	.addComponent(depotListPresenter, minHSizeTreePanel, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
		...
		layoutPanelTreeClientSelection.setVerticalGroup(
		    ...
		    .addGroup(layoutPanelTreeClientSelection.createSequentialGroup()
		              ...
		              .addComponent(depotListPresenter, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		*/
		...
		layoutIconPaneExtraFrames.setHorizontalGroup(
		    ...
		    .addGroup(layoutIconPaneExtraFrames.createSequentialGroup()
		              ...
		              .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
		              .addComponent(jButtonDash, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		              .addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
		...
		*/
		...
		panel_NetbootProductsettings  = new PanelGroupedProductSettings(configed.getResourceValue("MainFrame.panel_NetbootProductsettings"),main, main.getDisplayFieldsNetbootProducts());

									/*
									new PanelProductSettings(configed.getResourceValue("MainFrame.panel_NetbootProductsettings"), main, main.getDisplayFieldsNetbootProducts())
		                                {
			                                @Override
			                                protected void init()
			                                {
	...
	public void noGroupingAction()
{
	...
	*/
	...
	{
		/*
		ItemListener[] theListeners = stopItemListeners( jCheckBoxMenuItem_showWANactiveColumn );
	...
	{
		/*
		ItemListener[] theListeners = stopItemListeners( jCheckBoxMenuItem_showIPAddressColumn );
	...
	{
		FTextArea info = new FTextArea(this, de.uib.configed.Globals.APPNAME  + " Copyright Information",  true, new String[]{"ok"}, 700,300);
	...
	private void showLogfileLocationAction()
	{
		...
		info.getTextComponent().setSelectionStart(message.toString().length() - logging.getCurrentLogfilePath().length() );
	...
	public void stateChanged(ChangeEvent e)
	{
		if (e.getSource() == cbUefiBoot)
		{
			for (String client : main.getSelectedClients())
			{
				...
				logging.debug(this, "changedClientInfo client , " + client + ", " + changedClientInfo);
			}
	...
	*/
	...
	private void reactToHostDataChange( InputEvent e )
	{
		for (String client : main.getSelectedClients())
		{
			...
			{
				logging.info(this, "key released on textfielddescription ischangedtext " +jTextFieldDescription.isChangedText() );
			...
			else if (e.getSource() == jTextFieldOneTimePassword)
			{
				...
				//logging.info(this, "key released fieldonetimepassword  "+changedClientInfos + " .. " + changedClientInfo);
	...
	protected boolean handleInstallByShutdownChange(final boolean wantActive)
	{
		...
		*/
		...
		logging.info(this, "handleInstallByShutdownChange, old shutdown_value " + shutdown_value 
		...
		*/
		...
		else
		{
			...
			FTextArea fObsolete = 
			new FTextArea( (JFrame) Globals.frame1,
					...
					{	
						...
						else
						{
							JOptionPane.showMessageDialog(
								Globals.mainFrame,
								configed.getResourceValue("MainFrame.JOptionPane_installByShutdown_already_set"),
								configed.getResourceValue("MainFrame.JOptionPane_installByShutdown_already_set.title"),
			...
			if (fObsolete.getResult() != 1) goOn = false;
	...
	private class SwExporter implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			String filepathStart =
				showSoftwareLog_MultiClientReport.getExportDirectory()
				+ File.separator
			...
			for (String client :  main.getSelectedClients())
			{
				panelSWInfo.setHost(client);
						//main.getPersistenceController().getSoftwareAudit( client )) will be called via table.reload
	...
	public void setSoftwareAudit()
	{
		if (main.getSelectedClients() != null && main.getSelectedClients().length > 1)
		{
			...
			//logging.info(this, "setSoftwareAudit clientsWithoutScan: " + clientsWithoutScan);

		}
		else //case main.getSelectedClients() is null or length == 0; the case == 1 is handled by the following methos
		{
	...
	{
		//singleClient is primarily conceived as toggle: true for single host, false for multi hosts editing
