	...
	
{
	...
	private NewClientDialog(ConfigedMain main, Vector<String> depots)
	{
		...
		//jButton1.setRolloverIcon( Globals.createImageIcon( "images/checked_box.png", "Client" ) );
	...
	*/
	...
	protected void init()
	{
		...
		gpl.setHorizontalGroup(gpl.createParallelGroup()
			...
			.addGroup(gpl.createSequentialGroup()
				...
				.addGroup(gpl.createParallelGroup()
					...
					.addGroup(gpl.createSequentialGroup()
						.addGap(Globals.minVGapSize,Globals.minVGapSize,Globals.minVGapSize)
						.addComponent(jComboDomain, Globals.buttonWidth , Globals.buttonWidth , Short.MAX_VALUE)
					)
				)
				.addGap(Globals.minVGapSize,Globals.minVGapSize,Globals.minVGapSize)
			)
			...
			.addGroup(gpl.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(labelShutdownDefault, 2* Globals.buttonWidth, 3* Globals.buttonWidth, 3* Globals.buttonWidth)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
			...
			.addGroup(gpl.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(labelUefiDefault, 2* Globals.buttonWidth, 3* Globals.buttonWidth, 3* Globals.buttonWidth)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
			...
			.addGroup(gpl.createSequentialGroup()
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
				.addComponent(labelWanDefault, 2* Globals.buttonWidth, 3* Globals.buttonWidth, 3* Globals.buttonWidth)
				.addGap(Globals.hGapSize,Globals.hGapSize,Globals.hGapSize)
		...
		gpl.setVerticalGroup(gpl.createSequentialGroup()
			...
			.addGroup( gpl.createParallelGroup(GroupLayout.Alignment.CENTER )
				...
				.addComponent(jComboPrimaryGroup, Globals.buttonHeight,Globals.buttonHeight,Globals.buttonHeight)
			)
			/////// netboot 
			.addGap(Globals.vGapSize/2,Globals.vGapSize/2,Globals.vGapSize/2)
			.addGroup( gpl.createParallelGroup(GroupLayout.Alignment.CENTER )
	                         ...
	                         final String group, final String netbootProduct, final String localbootProduct)
	{
		...
		//logging.debug(this, "doAction1 host, existingHostNames.contains host " + hostname + ". " + selectedDomain  + ", "
	...
	public void  keyPressed(KeyEvent e)
	{
		...
		else
		{
			...
			if (e.getSource() == jButton1)
			{
                         // jButton1.setIcon( Globals.createImageIcon( "images/client_small_executing.png", "Client" ) );
			}
