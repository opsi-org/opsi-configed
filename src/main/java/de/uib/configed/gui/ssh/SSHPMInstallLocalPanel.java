...
public class SSHPMInstallLocalPanel extends SSHPMInstallPanel {
	...
	private void initComponents() {
		lbl_uploadFrom = new JLabel(configed.getResourceValue("SSHConnection.ParameterDialog.opsipackagemanager_install.jLabelLocalFrom"));
		lbl_uploadTo = new JLabel(configed.getResourceValue("SSHConnection.ParameterDialog.opsipackagemanager_install.jLabelLocalTo"));
	...
	private void initLayout() {
		...
		layout.setVerticalGroup( layout.createSequentialGroup()
			...
			.addGroup( layout.createParallelGroup(center)
				...
				.addComponent(btn_filechooser, Globals.buttonHeight, Globals.buttonHeight, Globals.buttonHeight)
			)
			.addGroup( layout.createParallelGroup(center)
		...
		layout.setHorizontalGroup( layout.createSequentialGroup()
			...
			.addGroup( layout.createParallelGroup(  )
				.addGroup( layout.createSequentialGroup()
					...
					.addComponent(btn_filechooser, Globals.buttonWidth, Globals.buttonWidth, Globals.buttonWidth)
				)
				.addGroup( layout.createSequentialGroup()
