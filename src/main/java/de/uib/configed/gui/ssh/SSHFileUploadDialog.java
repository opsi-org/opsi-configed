...
public class SSHFileUploadDialog extends FGeneralDialog
{
	...
	protected void init()
	{
		...
		rb_from_server = new JRadioButton(configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.rb_from_server"));
		group.add(rb_from_server);
		addListener(rb_from_server);
		rb_local = new JRadioButton(configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.rb_local"), true);
		group.add(rb_local);
		...
		lbl_overwriteExisting.setText(configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.lbl_overwriteExisting"));
		...
		lbl_modules_from.setText(configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.lbl_modules_from"));
		...
		filechooser_local.setDialogTitle(de.uib.configed.Globals.APPNAME + " " +configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.filechooser.title"));
		...
		btn_filechooser.setToolTipText(configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.filechooser.tooltip"));
		...
		//lbl_copy_to_modules_d.setText(configed.getResourceValue("SSHConnection.ParameterDialog.fileupload.lbl_copy_to_modules_d"));
			...
			inputPanelLayout.setHorizontalGroup(inputPanelLayout.createParallelGroup()
				...
				.addGroup(inputPanelLayout.createSequentialGroup()
					...
					.addGroup(inputPanelLayout.createParallelGroup()
						...
						.addGroup(inputPanelLayout.createSequentialGroup()
							.addGroup(h_parallelGroup) // parallelGroup can be overwritten by child classes
						)
					)
					.addGap(Globals.gapSize)
				)
