...
public class SSHPMInstallServerPanel extends SSHPMInstallPanel {
	...
	private void initComponents() {
		...
		cb_autocompletion.setToolTipText( configed.getResourceValue("SSHConnection.ParameterDialog.autocompletion.button_andopsipackage.combo.tooltip") );

		cb_autocompletion.setEnabled(true);
		btn_autocompletion = autocompletion.getButton();
		btn_autocompletion.setText(configed.getResourceValue("SSHConnection.ParameterDialog.autocompletion.button_andopsipackage"));
		btn_autocompletion.setToolTipText(configed.getResourceValue("SSHConnection.ParameterDialog.autocompletion.button_andopsipackage.tooltip"));
	}
