...
public class SSHWgetAuthenticationPanel extends SSHPMInstallPanel {
	static public final String LBLUSER = "lbl_user";
	static public final String LBLNEEDAUTH = "lbl_needAuthentication";
	static public final String CBNEEDAUTH = "cb_needAuthentication";
