	...
	private void initLayout()
	{
			...
			.addGroup(inputPanelLayout.createParallelGroup()
				.addGroup(inputPanelLayout.createSequentialGroup()
					...
					.addGroup(inputPanelLayout.createParallelGroup()
						...
						.addComponent(wgetAuthPanel.get(SSHWgetAuthenticationPanel.CBNEEDAUTH), GroupLayout.Alignment.LEADING,PREF, PREF, PREF)
		...
		inputPanelLayout.setVerticalGroup(inputPanelLayout.createSequentialGroup()
			...
			.addGroup(inputPanelLayout.createParallelGroup(GroupLayout.Alignment.CENTER)
				...
				.addComponent(wgetAuthPanel.get(SSHWgetAuthenticationPanel.CBNEEDAUTH), GroupLayout.Alignment.LEADING, Globals.buttonHeight, Globals.buttonHeight, Globals.buttonHeight)
			)
