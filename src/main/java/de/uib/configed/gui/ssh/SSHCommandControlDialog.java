...
public class SSHCommandControlDialog extends FGeneralDialog
{
	...
	private void init() 
	{
		...
		
		{
			...
			btn_test_command= new de.uib.configed.gui.IconButton(
				...
				"images/executing_command_red_22.png", "images/executing_command_red_22.png", "images/executing_command_red_22.png",true
			);
	...
	**/
	public void updateSelectedCommand(String menuText)
	{
		...
		else updateComponents( factory.parentdefaultForOwnCommands/*parentNull*/,"",factory.position_default, false, "" );
	}
