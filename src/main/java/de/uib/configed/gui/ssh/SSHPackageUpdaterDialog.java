	...
	private void init()
	{
		...
		cb_actions.addItemListener(new ItemListener(){
			public void itemStateChanged(ItemEvent e){
				if ((String) e.getItem()==configed.getResourceValue("SSHConnection.command.opsipackageupdater.action.list")){
	...
	private void initLayout()
	{
		...
		inputPanelLayout.setHorizontalGroup(inputPanelLayout.createSequentialGroup()
			...
			.addGroup(inputPanelLayout.createParallelGroup()
				...
				.addComponent(lbl_repos, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
			)
			.addGap(Globals.gapSize)
			.addGroup(inputPanelLayout.createParallelGroup()
