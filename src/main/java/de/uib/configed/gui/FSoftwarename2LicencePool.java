...
{
	public final static String valNoLicencepool = "---";
	...
	public enum Softwarename2LicencepoolRestriction 
		{SHOW_ALL_NAMES, SHOW_ONLY_NAMES_WITH_VARIANT_LICENCEPOOLS, 
		SHOW_ONLY_NAMES_WITHOUT_ASSIGNED_LICENCEPOOL};
		
	public enum Softwarename2LicencepoolChangeOption
		{
			NO_CHANGE,
			REMOVE_ALL_ASSIGNEMENTS,
			SET_ALL_TO_GLOBAL_SELECTED_LICENCEPOOL,
			SET_ALL_TO_SELECTED_LINE
		}
	...
	public FSoftwarename2LicencePool( JFrame owner, ControlPanelAssignToLPools myController )
	{
		super(
		    ...
		    owner,
		    configed.getResourceValue("FSoftwarename2LicencePool.title"),
		    false,
		    new String[]{
		        //"save",
		        //"cancel",
		                                           ...
		                                           )
		{
			...
			{
				logging.info(this, "panelSWxLicencepool ListSelectionEvent " 
					 + e);
				super.valueChanged( e );
				
				String labelText = 	configed.getResourceValue("FSoftwarename2LicencePool.labelSetAllAssignmentsToPoolFromSelectedRow");
				...
				if ( val != null && isSingleSelection() && getTableModel().getRowCount() > 1 && !((String) val).equals( valNoLicencepool) )
				{
	    ...
	    */
		...
		labelRemoveAllAssignments = new JLabel( configed.getResourceValue("FSoftwarename2LicencePool.labelRemoveAllAssignments") );
		...
		buttonSetAllAssignmentsToGloballySelectedPool.setIcon( de.uib.configed.Globals.createImageIcon("images/list-add-14.png",""));
		labelSetAllAssignmentsToGloballySelectedPool = new JLabel(configed.getResourceValue("FSoftwarename2LicencePool.labelSetAllAssignmentsToGloballySelectedPool") ) ;
		buttonSetAllAssignmentsToGloballySelectedPool.addActionListener(
			new ActionListener(){
				public void actionPerformed(ActionEvent e)
				{
					//panelSWxLicencepool.cancel();
		...
		buttonSetAllAssignmentsToPoolFromSelectedRow.setIcon( de.uib.configed.Globals.createImageIcon("images/list-add-14.png",""));
		labelSetAllAssignmentsToPoolFromSelectedRow	= new JLabel(configed.getResourceValue("FSoftwarename2LicencePool.labelSetAllAssignmentsToPoolFromSelectedRow")); //assign each to pool from selected row: ") ;
		...
		panelActionLayout.setVerticalGroup( panelActionLayout.createSequentialGroup()
			.addGroup( panelActionLayout.createParallelGroup( javax.swing.GroupLayout.Alignment.CENTER )
				.addComponent(buttonRemoveAllAssignments, 5, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(labelRemoveAllAssignments, 5, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				)
			.addGroup( panelActionLayout.createParallelGroup( javax.swing.GroupLayout.Alignment.CENTER )
				.addComponent(buttonSetAllAssignmentsToGloballySelectedPool, 5, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(labelSetAllAssignmentsToGloballySelectedPool, 5, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				)
			.addGroup( panelActionLayout.createParallelGroup( javax.swing.GroupLayout.Alignment.CENTER )
				.addComponent(buttonSetAllAssignmentsToPoolFromSelectedRow, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(labelSetAllAssignmentsToPoolFromSelectedRow, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				)
		);
			
		panelActionLayout.setHorizontalGroup( panelActionLayout.createParallelGroup()
			.addGroup( panelActionLayout.createSequentialGroup()
				.addGap(Globals.hGapSize)
				.addComponent(buttonRemoveAllAssignments, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize)
				.addComponent(labelRemoveAllAssignments, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addGap(Globals.hGapSize)
				)
			.addGroup( panelActionLayout.createSequentialGroup()
				.addGap(Globals.hGapSize)
				.addComponent(buttonSetAllAssignmentsToGloballySelectedPool, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize)
				.addComponent(labelSetAllAssignmentsToGloballySelectedPool, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addGap(Globals.hGapSize)
				)
			.addGroup( panelActionLayout.createSequentialGroup()
				.addGap(Globals.hGapSize)
				.addComponent(buttonSetAllAssignmentsToPoolFromSelectedRow, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize)
				.addComponent(labelSetAllAssignmentsToPoolFromSelectedRow, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addGap(Globals.hGapSize)
				)
		);
		...
		layoutSWx.setVerticalGroup( layoutSWx.createSequentialGroup()
			.addGap(Globals.vGapSize)
			.addComponent(panelSWxLicencepool,100, 200, Short.MAX_VALUE)
			.addGap(Globals.vGapSize)
			.addComponent(panelAction, 70, 70, 100)
			.addGap(Globals.vGapSize)
		...
		layoutSWx.setHorizontalGroup( layoutSWx.createParallelGroup()
			.addGroup( layoutSWx.createSequentialGroup()
				.addGap( Globals.hGapSize )
				.addComponent(panelAction, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addGap( Globals.hGapSize )
			)
			.addGroup( layoutSWx.createSequentialGroup()
				.addGap( Globals.hGapSize )
				.addComponent(panelSWxLicencepool,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addGap( Globals.hGapSize )
			)
		);
		...
		additionalPane.setBackground( de.uib.configed.Globals.backgroundWhite );// Color.YELLOW );//de.uib.configed.Globals.backLightBlue );
	...
	protected void initDataStructure()
	{
		...
		showOnlyNamesWithVariantLicences = 
			new DefaultTableModelFilterCondition("" + Softwarename2LicencepoolRestriction.SHOW_ONLY_NAMES_WITH_VARIANT_LICENCEPOOLS)
			{
		...
		showOnlyNamesWithoutLicences =
			new DefaultTableModelFilterCondition("" + Softwarename2LicencepoolRestriction.SHOW_ONLY_NAMES_WITHOUT_ASSIGNED_LICENCEPOOL)
			{
				public void setFilter( TreeSet<Object> filter)
				{
				}
		...
		panelSWnames.setListSelectionMode(
		    ListSelectionModel.SINGLE_SELECTION
		);

		panelSWnames.addListSelectionListener(
	...
	private void setSWInfo( String swId, String pool)
	{
		...
		logging.info( this, " setSWInfo in " + 
		persist.getInstalledSoftwareName2SWinfo().get(
			AuditSoftwareXLicencePool.produceMapFromSWident( swId ).get( SWAuditEntry.NAME ) )
		);
	}
	...
	public void setTableModel( GenTableModel model  )
	{
			...
			//test
		{
			...
			this.modelSWnames = new GenTableModel(
			                        null,  //no updates
			                        ...
			                        0,
			                        new int[]{},
			                        (TableModelListener)panelSWnames ,
			                        updateCollection
			                    )
					...
					public void produceRows()
					{
						...
						while (!foundVariantLicencepools && i < getRowCount())
						{
							foundVariantLicencepools =
								checkExistNamesWithVariantLicencepools( (String) getValueAt(i,0 ));
							i++;
						}
	...
	public void setPreselectionForName2Pool( Softwarename2LicencepoolRestriction val )
	{
		...
		{
			case SHOW_ALL_NAMES: 
				modelSWnames.clearFilter(); filtering = false; break;
	...
	public boolean checkExistNamesWithVariantLicencepools()
	{
		...
		{
			foundVariants =
				checkExistNamesWithVariantLicencepools( (String) modelSWnames.getValueAt(i,0 ));
			i++;
		}
	...
	public void setGlobalPool( String licencePool )
	{
		...
		String labelText = configed.getResourceValue("FSoftwarename2LicencePool.labelSetAllAssignmentsToGloballySelectedPool");
	...
	private void setTableModelSWxLicencepool( String swName )
	{
		...
		MapTableUpdateItemFactory updateItemFactoySWxLicencepool 
				= new MapTableUpdateItemFactory(
						columnNamesSWxLicencepool,
						classNamesSWxLicencepool,
						0 //keycol
						);
		
		modelSWxLicencepool = new GenTableModel(
					updateItemFactoySWxLicencepool,
					new DefaultTableProvider(
			...
			new MapItemsUpdateController(
				...
				new MapBasedUpdater(){
					public String sendUpdate(Map<String, Object> rowmap){
						...
						return persist.editPool2AuditSoftware(
							swID,
							licensePoolID_old,
							licensePoolID_new
							);
