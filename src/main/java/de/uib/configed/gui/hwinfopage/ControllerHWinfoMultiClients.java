...
public class ControllerHWinfoMultiClients
{
	...
	de.uib.utilities.table.TableModelFilterCondition filterConditionHwForSelectedHosts =
	    new de.uib.utilities.table.TableModelFilterCondition()
	    {
		    ...
		    {
		    	String result = "TableModelFilterCondition: filterConditionHwForSelectedHosts, filter == null " + (filter == null);
		    	if (filter != null)
	...
	protected void buildSurrounding()
	{
		...
		buttonReload.addActionListener( new ActionListener(){
				public void actionPerformed(ActionEvent e)
				{
					...
					//panel.reload();
					//logging.info(this, "after reload: columns " + panel.getTableModel().getColumnNames() );
					*/
				}
			}
		);
		...
		buttonConfigureColumns.addActionListener( new ActionListener(){
				public void actionPerformed(ActionEvent e)
				{
					...
					controllerHWinfoColumnConfiguration
					= new ControllerHWinfoColumnConfiguration( main, persist );
