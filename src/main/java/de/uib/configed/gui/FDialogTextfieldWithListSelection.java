	...
	
{
	...
	public FDialogTextfieldWithListSelection (JFrame owner, String title, boolean modal, String[] buttonList, Icon[] icons, int lastButtonNo, int preferredWidth, int preferredHeight, 
		boolean lazyLayout, JPanel addPane)
	{
		super( owner, title, modal, buttonList, icons, lastButtonNo, preferredWidth, preferredHeight, lazyLayout, addPane);
	}
	...
	protected void allLayout()
	{
		...
		allpane.setBackground(de.uib.configed.Globals.backLightBlue ); //Globals.nimbusBackground);///Globals.backgroundWhite); //Globals.backLighter);//Globals.backgroundWhite);//(myHintYellow);
	...
	public JPanel initPanel()
	{
		...
		theLayout.setHorizontalGroup( theLayout.createParallelGroup()
			.addGroup( theLayout.createSequentialGroup()
				.addGap(Globals.hGapSize)
				.addComponent( labelField, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)//Globals.labelWidth, Globals.labelWidth  *2,  Globals.labelWidth *2 ) 
				.addGap(Globals.hGapSize)
				.addGap(Globals.hGapSize)
	...
	protected void preAction1()
	{
		...
		//logging.info(this, "preAction1 resultingText, selectedListElement "	+ resultingText + ", " + selectedListElement);
	}
