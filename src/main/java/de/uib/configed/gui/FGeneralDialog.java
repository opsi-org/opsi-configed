	...
	public FInfoDialog(Frame owner, String title, String message, boolean modal, int lastButtonNo)
{
	...
	*/
	...
	public FGeneralDialog(JFrame owner, String title, boolean modal, String[] buttonList, int preferredWidth, int preferredHeight)
	{
		this (owner, title, modal, buttonList, buttonList.length, preferredWidth, preferredHeight);
	}
	
	public FGeneralDialog(JFrame owner, String title, boolean modal, String[] buttonList, int lastButtonNo, int preferredWidth, int preferredHeight)
	{
		this (owner, title, modal, buttonList, null, buttonList.length, preferredWidth, preferredHeight);
	}
	
	public FGeneralDialog(JFrame owner, String title, boolean modal, String[] buttonList, Icon[] icons, int lastButtonNo, int preferredWidth, int preferredHeight)
	{
		this(owner, title, modal, buttonList, icons, lastButtonNo, preferredWidth, preferredHeight, false);
	}
	
	
	public FGeneralDialog(JFrame owner, String title, boolean modal, String[] buttonList, Icon[] icons, int lastButtonNo, int preferredWidth, int preferredHeight, boolean lazyLayout)
	{
	...
	public FGeneralDialog(JFrame owner, String title, boolean modal, String[] buttonList, Icon[] icons, int lastButtonNo, int preferredWidth, int preferredHeight, boolean lazyLayout, JPanel addPane)
	{
		super(owner, modal);
		this.owner = owner;
	...
	*/
	...
	private void construct( String title, boolean modal, String[] buttonList, Icon[] icons, int lastButtonNo, int preferredWidth, int preferredHeight, boolean lazyLayout, JPanel addPane)
	{
		registerWithRunningInstances();

		setIconImage (Globals.mainIcon);
		
		//logging.info(this, "construct " + lastButtonNo + " buttons " + Arrays.toString( buttonList ));
	...
	public FGeneralDialog(java.awt.Window owner, String title, String[] buttonList, int preferredWidth, int preferredHeight)
	{
		super( owner );
	...
	/*
	public FGeneralDialog(int test, java.awt.Window owner, String title, String[] buttonList, int preferredWidth, int preferredHeight)
	{
		super(owner);
		this.owner = owner;
		//super();??
	...
	*/
	...
	protected void allLayout()
	{
		...
		allLayout.setVerticalGroup( allLayout.createSequentialGroup()
			...
			.addComponent(southPanel, 2*  Globals.lineHeight, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)  
		);
