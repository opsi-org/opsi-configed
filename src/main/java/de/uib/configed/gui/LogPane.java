			...
			implements KeyListener, ActionListener
{
	...
	private Integer produceInitialMaxShowLevel()
	{
		...
		{
			logging.warning(this, "savedMaxShownLogLevel could not be read, value "+  configed.savedStates.savedMaxShownLogLevel.deserialize());
		}
		...
		*/
		...
		layoutCommandpane.setHorizontalGroup(
		    ...
		    .addGroup(layoutCommandpane.createSequentialGroup()
		              ...
		              .addComponent(buttonFontPlus, Globals.graphicButtonWidth/2, Globals.graphicButtonWidth/2, Globals.graphicButtonWidth/2)
		              .addGap(Globals.gapSize/2,Globals.gapSize/2,Globals.gapSize/2)
		              .addComponent(buttonFontMinus, Globals.graphicButtonWidth/2, Globals.graphicButtonWidth/2, Globals.graphicButtonWidth/2)
		              .addGap(Globals.gapSize,Globals.gapSize,Globals.gapSize)
		              .addGap(Globals.gapSize,Globals.gapSize,Globals.gapSize)
		              ...
		              .addGap(Globals.gapSize,Globals.gapSize,Globals.gapSize)
		              .addComponent( spinnerMinLevel, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	public void buildDocument()
	{
		...
		SwingUtilities.invokeLater( new Runnable() {
			                            public void run()
			                            {
			                            	//jTextPane.setDocument(document); //if called here, ths cursor location is lost
	...
	public void keyPressed(KeyEvent e)
	{
		...
		else if (e.getSource() ==  jComboBoxSearch || e.getSource() == jTextPane)
		{
			if (
			    ...
			    &&  jComboBoxSearch.getSelectedItem() != null && !jComboBoxSearch.getSelectedItem().toString().equals("")
			)
			{
				search();
			}
