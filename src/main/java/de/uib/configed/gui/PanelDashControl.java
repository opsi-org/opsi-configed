...
public class PanelDashControl extends JPanel
{
	...
	protected void initComponents()
	{
		...
		dashLayout.setVerticalGroup( dashLayout.createSequentialGroup()
			...
			.addComponent(showDashOnLicencesActivation, Globals.buttonHeight, Globals.buttonHeight, Globals.buttonHeight)
		);
		dashLayout.setHorizontalGroup( dashLayout.createParallelGroup()
			...
			.addComponent(showDashOnLicencesActivation, 100,GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		);
	}
