	...
	implements Comparable
{
	...
	{
		this( productId, productVersion, packageVersion, productType, null); //compatibility to usages without locked parameter
	}
	
	public OpsiPackage(String productId, String productVersion, String packageVersion, String productType, Boolean locked)
	{
