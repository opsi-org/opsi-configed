...
{
	/*
	 * desc SOFTWARE_LICENSE ; | Field | Type | Null | Key | Default | Extra |
	 * softwareLicenseId | varchar(100) | NO | PRI | NULL | licenseContractId |
	 * varchar(100) | NO | MUL | NULL | boundToHost | varchar(255) | YES | MUL |
	 * NULL | maxInstallations | int(11) | YES | | NULL | | expirationDate |
	 * timestamp | NO | | 0000-00-00 00:00:00 | type | varchar(30) | NO | MUL | NULL
	 * |
	 */
	...
	/*
	 * @Override public Object put(String key, Object value) { assert
	 * KEYS.indexOf(key) > -1 : "not valid key " + key;
	 * 
	 * if (KEYS.indexOf(key) > -1) { if (key.equals(typeKEY) &&
	 * TYPE_LIST.indexOf(value) == -1) logging.warning(this, "value " + value +
	 * " not possible for key " + key);
	 * 
