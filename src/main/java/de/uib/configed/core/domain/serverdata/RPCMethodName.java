...
public enum RPCMethodName {
	...
	HOST_GET_OBJECTS("host_getObjects"), HOST_GET_CLIENTS("host_getClients"), HOST_CREATE_CLIENTS("host_createClients"),
	HOST_CREATE_OBJECTS("host_createObjects"), HOST_UPDATE_OBJECTS("host_updateObjects"),
	HOST_UPDATE_CLIENTS("host_updateClients"), HOST_DELETE("host_delete"),
	...
	HOST_CONTROL_REBOOT("hostControl_reboot"), HOST_CONTROL_GET_ACTIVE_SESSIONS("hostControl_getActiveSessions"),
