...
public class MainView implements View
{
	...
	@FXML private InstalledOSComparison installedOSComparison;
	@FXML private LicenseStatusComparison licenseStatusComparison;
	@FXML private ModuleStatusComparison moduleStatusComparison;
	@FXML private ProductStatusComparison productStatusComparison;
	@FXML public ChoiceBox<String> selectedDepotChoiceBox;
	@FXML private VBox dashboardSceneVBox;
	@FXML private VBox clientDataDisplayAreaVBox;
	@FXML private VBox productDataDisplayAreaVBox;
	@FXML private VBox moduleDataDisplayAreaVBox;
	@FXML private VBox licenseDataDisplayAreaVBox;
	@FXML public Label depotsNumberLabel;
	@FXML public Label clientsNumberLabel;
	@FXML public Label productsNumberLabel;
	@FXML public Label localbootProductsNumberLabel;
	@FXML public Label netbootProductsNumberLabel;
	@FXML public Label installedOSsNumberLabel;
	@FXML public Label modulesNumberLabel;
	@FXML public Label licensesNumberLabel;
	@FXML public Text depotTypeText;
	@FXML public Text depotDescriptionText;
	@FXML public VBox dataLoadingScreenVBox;
	...
	private void loadData()
	{
		...
		selectedDepotChoiceBox.getSelectionModel().selectedItemProperty().addListener((observableValue, oldValue, newValue) -> observer.notify(NEW_DEPOT_SELECTED_SERVICE, newValue));
	}
