...
public class DateTimePicker extends DatePicker {
	...
	private LocalDateTime initialDateTime = LocalDateTime.now(ZONEID);
	private ObjectProperty<LocalDateTime> dateTimeValue = new SimpleObjectProperty<>(initialDateTime.plusDays(7));
