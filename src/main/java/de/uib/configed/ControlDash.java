...
public class ControlDash {
	...
	public void showInfo() {
		...
		if (fDash == null) {
			...
			// fDash = new FGeneralDialog( Globals.mainFrame, Globals.APPNAME + " info",
			// panelDash);
			...
			if (Globals.mainFrame != null) {
				fDash.setLocation((int) Globals.mainFrame.getX() + Globals.locationDistanceX,
	...
	protected String calculateVariantLicencepools() {
		 ...
		 * logging.info("modelSWnames getValueAt row, col " + row + ", " + col); return
