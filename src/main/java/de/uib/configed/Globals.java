...
public class Globals {
    ...
    public static final String VERSION = "4.2.17.1.1";
    public static final String VERDATE = "(2022/10/18)";
    public static final String VERHASHTAG = "";

    public static final String ZERODATE = "";

    public static final String REQUIRED_SERVICE_VERSION =
        "4.1.0";

    public static final String MIN_SUPPORTED_OPSI_VERSION =
        "4.1.0";
    ...
    public static final String APPNAME =
        "opsi config editor";
    public static final String iconresourcename =
        "opsi.gif";

    public static final String opsiDocpage =
        "http://www.opsi.org";
    public static final String opsiSupportpage =
        "http://opsi.org/support";
    public static final String opsiForumpage =
        "http://forum.opsi.org";

    public static final String BUNDLE_NAME =
        "de/uib/messages/configed";

    public static final boolean showIconsInProductTable =
        false;
    public static final Color INVISIBLE = new Color(
        11,
        13,
        17
    ); //some value which shall be interpreted as identical with background;
    ...
    public static class ProductPackageVersionSeparator {
        ...
        public static String formatKeyForDisplay(
            String key
        ) {
    ...
    public static final Font defaultFont = new java.awt.Font(
        "SansSerif",
        0,
        11
    );
    public static final Font defaultFontStandardBold = new java.awt.Font(
        "SansSerif",
        Font.BOLD,
        11
    );
    public static final Font defaultFontSmall = new java.awt.Font(
        "SansSerif",
        0,
        9
    );
    public static final Font defaultFontSmallBold = new java.awt.Font(
        "SansSerif",
        Font.BOLD,
        9
    );
    ...
    public static final Font defaultFontBig = new java.awt.Font(
        "SansSerif",
        0,
        12
    );
    public static final Font defaultFontBold = new java.awt.Font(
        "SansSerif",
        Font.BOLD,
        12
    );
    public static final Font defaultFontTitle = new java.awt.Font(
        "SansSerif",
        0,
        16
    );
    ...
    public static final Color backgroundWhite = new Color(
        245,
        245,
        245
    );
    public static final Color backgroundGrey = new Color(
        220,
        220,
        220
    );
    public static final Color backgroundLightGrey = new Color(
        230,
        230,
        230
    );
    public static final Color backLightBlue = new Color(
        220,
        228,
        242
    ); // new Color (210,216,232);
    public static final Color backLighterBlue = new Color(
        230,
        230,
        245
    );
    public static final Color backVeryLightBlue = new Color(
        240,
        240,
        245
    );
    //public static final Color backLight = new Color (220,230,230);
    public static final Color backBlue = new Color(
        200,
        200,
        250
    );
    public static final Color backYellow = new java.awt.Color(
        255,
        255,
        182
    );
    public static final Color backLightYellow = new java.awt.Color(
        250,
        248,
        221
    );
    public static final Color backTabsColor = new java.awt.Color(
        206,
        223,
        247
    );
    public static final Color darkOrange = new java.awt.Color(
        218,
        180,
        4
    );
    public static final Color lightBlack = new Color(
        30,
        30,
        30
    );
    public static final Color blue = new Color(30, 30, 100);
    public static final Color blueGrey = new Color(
        180,
        190,
        190
    );
    public static final Color violett = new Color(
        160,
        170,
        200
    );
    public static final Color greyed = new Color(
        150,
        150,
        150
    );
    public static final Color failedBackColor = new Color(
        100,
        100,
        100
    );
    public static final Color okGreen = new Color(
        20,
        140,
        20
    );
    public static final Color actionRed = new Color(
        239,
        4,
        4
    );
    public static final Color unknownBlue = new Color(
        40,
        17,
        213
    );

    public static void formatButtonSmallText(
    ...
    public static final Color nimbusSelectionBackground = new Color(
        57,
        105,
        138
    );
    public static final Color nimbusBackground = new Color(
        214,
        217,
        223
    );
    public static final Color backNimbus = new Color(
        214,
        219,
        222
    );
    public static final Color backNimbusLight = new Color(
        224,
        229,
        235
    );
    ...
    public static final Color defaultTableCellBgColor1 =
        Color.white; //new Color (255,255,255);
    public static final Color defaultTableCellBgColor2 =
        backLightYellow; // new java.awt.Color (250, 48, 221);
    ...
    public static final Color defaultTableSelectedRowBright = new Color(
        221,
        233,
        249
    );
    ...
    public static final Color defaultTableCellBgColor00 =
        backLightYellow; // new java.awt.Color (250, 48, 221);
    public static final Color defaultTableCellBgColor01 = new Color(
        236,
        235,
        214
    );
    public static final Color defaultTableCellBgColor10 =
        Color.white; //new Color (255,255,255);
    public static final Color defaultTableCellBgColor11 =
        backgroundWhite;

    public static final Color defaultTableHeaderBgColor = new Color(
        222,
        231,
        247
    ); //new Color (206,223,247);
    public static final Color defaultTableCellSelectedBgColor = new Color(
        206,
        224,
        235
    ); // new Color (184,207,229);
    public static final Color defaultTableCellSelectedBgColorNotEditable = new Color(
        189,
        207,
        231
    );

    public static final Color logColorEssential = new Color(
        0,
        0,
        0
    ); //1 - black
    public static final Color logColorCritical = new Color(
        255,
        0,
        0
    ); //new Color(200,0,200); // 2 - red
    public static final Color logColorError = new Color(
        200,
        100,
        0
    ); //new Color(200,0,0); // 3 - orange
    public static final Color logColorWarning = new Color(
        20,
        20,
        200
    ); // new Color(0,200,0); //new Color(255,128,0); //4 - blue
    public static final Color logColorNotice = new Color(
        10,
        150,
        10
    ); //new Color(0,200,0); //5 -  green
    public static final Color logColorInfo = new Color(
        50,
        50,
        50
    ); //6 - grey
    public static final Color logColorDebug = new Color(
        150,
        150,
        150
    ); //7 - brighter grey
    public static final Color logColorDebug2 = new Color(
        150,
        150,
        150
    );
    public static final Color logColorConfidential = new Color(
        150,
        150,
        0
    );
	...
	*/
    ...
    public static final Color opsiLogoBlue = new Color(
        106,
        128,
        174
    );
    public static final Color opsiLogoLightBlue = new Color(
        195,
        200,
        222
    );
    ...
    public static javax.swing.border.Border createPanelBorder() {
        return new javax.swing.border.LineBorder(
            Globals.backBlue,
            2,
            true
        );
    ...
    public static final Dimension shortButtonDimension = new Dimension(
        buttonWidth / 4,
        buttonHeight
    );
    public static final Dimension textfieldDimension = new Dimension(
        buttonWidth,
        lineHeight
    );
    public static final Dimension labelDimension = new Dimension(
        labelWidth,
        lineHeight
    );
    public static final Dimension shortlabelDimension = new Dimension(
        60,
        lineHeight
    );
    public static final int counterfieldWidth = 160;
    public static final Dimension counterfieldDimension = new Dimension(
        counterfieldWidth,
        lineHeight
    );

    public static final Dimension modeSwitchDimension = new Dimension(
        50,
        50
    );
    ...
    public static final Dimension graphicButtonDimension = new Dimension(
        graphicButtonWidth,
        graphicButtonHeight
    );
    ...
    public static final int[] maxLogSizes = new int[] {
        4 * 1024 * 1024,
        8 * 1024 * 1024,
        8 * 1024 * 1024,
        0,
    ...
    public static final String CONFLICTSTATEstring =
        "mixed";
    public static final Color CONFLICTSTATEcellcolor = new Color(
        255,
        180,
        180
    );
    ...
    public static java.awt.Dimension helperFormDimension = new java.awt.Dimension(
        1100,
        600
    );
    ...
    public static java.awt.Dimension dialogFrameDefaultSize = new java.awt.Dimension(
        dialogFrameDefaultWidth,
    ...
    public static String fillStringToLength(
        String s,
        int len
    ) {
        ...
        for (int i = 0; i < s.length(); i++) buff.append(
            s.charAt(i)
        );

        for (int i = s.length(); i < len; i++) buff.append(
            ' '
        );
    ...
    public static java.net.URL getImageResourceURL(
        String relPath
    ) {
        String resourceS = imageBase + relPath;

        ClassLoader cl =
            de.uib.configed.Globals.class.getClassLoader();
        java.net.URL imgURL = cl.getResource(resourceS);
        if (imgURL != null) {
            return imgURL;
        } else {
            de.uib.utilities.logging.logging.warning(
                "Couldn't find file  " + relPath
            );
            return null;
        }
    }
    ...
    public static Image createImage(String path) {
        ...
        try {
            if (imgURL != null) {
                return java.awt.Toolkit
                    .getDefaultToolkit()
                    .createImage(imgURL);
            } else {
                de.uib.utilities.logging.logging.info(
    ...
    public static String getMinutes() {
        String sqlNow = new java.sql.Timestamp(
            new java.util.GregorianCalendar()
                .getTimeInMillis()
        )
            .toString();
        sqlNow =
            sqlNow.substring(0, sqlNow.lastIndexOf(':'));
    ...
    public static final ArrayList<Object> getNowTimeListValue(
        ...
        String now = new java.sql.Timestamp(
            new java.util.GregorianCalendar()
                .getTimeInMillis()
        )
            .toString();
        now = now.substring(0, now.indexOf("."));
        if (comment != null) result.add(
            now + " " + comment
        ); else result.add(now);
    ...
    public static Color brightenColor(java.awt.Color c) { //experimental
    ...
    public static boolean isGlobalReadOnly() {
        boolean result = PersistenceControllerFactory
            .getPersistenceController()
            .isGlobalReadOnly();

        de.uib.utilities.logging.logging.info(
            "Globals got readonly " + result
        );
    ...
    public static boolean forbidEditingTargetSpecific() {
        ...
        de.uib.utilities.logging.logging.debug(
            "forbidEditing for target " +
            ConfigedMain.getEditingTarget() +
            "?"
        );
