...
public class CopyrightInfos
{
    ...
    static final String completeVersionInfo = System.getProperty("java.runtime.version");

    private static final java.util.ArrayList<String> infos;
    static{
        infos = new java.util.ArrayList<String>();

        infos.add(de.uib.configed.Globals.APPNAME  +  "  Version " + de.uib.configed.Globals.VERSION + " " + de.uib.configed.Globals.VERDATE + " " + de.uib.configed.Globals.VERHASHTAG );
        ...
        infos.add("");
        infos.add("running on java version " + completeVersionInfo);
        infos.add("");
        infos.add("");
        infos.add(configed.getResourceValue("CopyrightInfos.thanksTo"));
        infos.add("");
        infos.add("commons-io Apache library");
        //infos.add("licensed by  Apache License Version 2.0, January 2004");
    ...
    public static java.util.ArrayList<String> get()
    {
        return infos;
    }
}