			...
			extends javax.swing.table.AbstractTableModel
{
	...
	public String getColumnName (int col)
	{
		...
		switch (col)
		{
		case 0 : result = configed.getResourceValue("ProductInfoPane.RequirementsTable.requiredProduct") ; break;
			/*
			...
			*/
		case 1 : result = configed.getResourceValue("ProductInfoPane.RequirementsTable.requirementTypeDefault"); break;
		case 2 : result = configed.getResourceValue("ProductInfoPane.RequirementsTable.requirementTypeBefore"); break;
		case 3 : result = configed.getResourceValue("ProductInfoPane.RequirementsTable.requirementTypeAfter"); break;
	...
	public Object getValueAt(int row, int col)
	{
		...
		if (col == 0)
		{
			switch( rowTypeIndex )
			{
				...
				case 1: result = indent + configed.getResourceValue("ProductInfoPane.RequirementsTable.requirementCondition") + " setup"; break;
				case 2: result = indent + configed.getResourceValue("ProductInfoPane.RequirementsTable.requirementCondition") + " uninstall"; break;
			}
		}
	...
	{
		int rowTypeIndex = row % noOfRowTypes;
		if (rowTypeIndex == 1 && col == 0) return false;
		if (rowTypeIndex == 2 && col == 0) return false;
		return false;
	}
	...
	protected class MyColorizer
	{
		...
		( java.awt.Component cell, boolean isSelected, int row, int col)
		{
