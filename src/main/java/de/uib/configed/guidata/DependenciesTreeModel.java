...
import de.uib.configed.gui.productpage.DependenciesTree;
...
public class DependenciesTreeModel {
	...
	*/
	private class Graph {
		...
		public void addEdges(Map<String, java.util.List<Map<String, String>>> dependencies, Map<String, Integer> productMap) {
