...
public class ControlPanelEnterLicence extends ControlMultiTablePanel { // tab new licence
	...
	public void init() {
		...
		MapTableUpdateItemFactory updateItemFactoryLicencepools = new MapTableUpdateItemFactory(modelLicencepools,
				columnNames, classNames, 0);
		modelLicencepools = new GenTableModel(updateItemFactoryLicencepools, mainController.licencePoolTableProvider,
				/*
				 * new DefaultTableProvider( new RetrieverMapSource(columnNames, classNames, new
				 * MapRetriever(){ public Map retrieveMap() { return persist.getLicencePools();
				 * } }) ),
				 */
