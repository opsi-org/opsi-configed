...
public class OpsiDataSerializer extends de.uib.configed.clientselection.Serializer
{
	...
	{
		//logging.info(this, "getData , we have savedSearches " + controller.getSavedSearches());
		...
		//logging.info(this, "getData for name " + name + " " + controller.getSavedSearches().get(name)
		//	+ " this gives the value for serialization " + controller.getSavedSearches().get(name).getSerialization() );
