...
public class ControlPanelLicencesReconciliation extends ControlMultiTablePanel {
  ...
  public void init() {
    ...
    java.util.List<String> extraHostFields = persist.getServerConfigStrings(
      persist.KEY_HOST_EXTRA_DISPLAYFIELDS_IN_PanelLicencesReconciliation
    );
    ...
    logging.debug(
      this,
      "cols index_used_by_opsi  " +
      index_used_by_opsi +
      " , " +
      index_SWinventory_used
    );
    //System.exit(0);
    classNames.add("java.lang.String");
    ...
    modelLicencesReconciliation.setFilterCondition(
      new TableModelFilterCondition() {
    ...
    updateItemFactoryLicencesReconciliation.setSource(
      modelLicencesReconciliation
    );
    ...
    col =
      thePanel.panelReconciliation
        .getColumnModel()
        .getColumn(index_used_by_opsi);
    col.setCellRenderer(
      new de.uib.utilities.table.gui.CheckBoxTableCellRenderer()
    );
    ...
    col =
      thePanel.panelReconciliation
        .getColumnModel()
        .getColumn(index_SWinventory_used);
    col.setCellRenderer(
      new de.uib.utilities.table.gui.CheckBoxTableCellRenderer()
    );
    col.setPreferredWidth(130);
