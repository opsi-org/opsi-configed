...
public enum RPCMethodName {
	...
	CONFIG_STATE_GET_OBJECTS("configState_getObjects"), CONFIG_STATE_UPDATE_OBJECTS("configState_updateObjects"),
	...
	BACKEND_INFO("backend_info"), BACKEND_GET_INTERFACE("backend_getInterface"),
