...
public class UserSshConfig extends UserConfigModule
{
	...
	private final static String KEY_SSH_MENU_ACTIVE_description = configed.getResourceValue("PersistenceController.SSH_MENU_ACTIVE");
	...
	private final static String KEY_SSH_CONFIG_ACTIVE_description = configed.getResourceValue("PersistenceController.SSH_CONFIG_ACTIVE");
	...
	private final static String KEY_SSH_COMMANDCONTROL_ACTIVE_description = configed.getResourceValue("PersistenceController.SSH_CONTROL_ACTIVE");
	...
	private final static String KEY_SSH_COMMANDS_ACTIVE_description = configed.getResourceValue("PersistenceController.SSH_COMMANDS_ACTIVE");
