...
public class DataStubNOM extends DataStub
{
	...
	*/
	...
	protected void retrieveProductInfos()
	{
		...
		if (product2versionInfo2infos == null)
		{
			...
			*/
			...
			List<Map<String, Object>>  retrievedList  = persist.retrieveListOfMapsNOM(
			            callAttributes,
			            callFilter,
			            "product_getObjects"
			        );
	...
	protected void retrieveProductsAllDepots()
	{
		...
		if (depot2LocalbootProducts != null) logging.debug(this,"depot2LocalbootProducts " + depot2LocalbootProducts.size());
		if (depot2NetbootProducts != null) logging.debug(this,"depot2NetbootProducts" + depot2NetbootProducts.size());
		retrieveProductInfos();
		...
		)
		{
			...
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " productOnDepot");
			String[] callAttributes = new String[]{};
			HashMap callFilter = new HashMap();

			List<Map<String, Object>> packages = persist.retrieveListOfMapsNOM(
			                                         callAttributes,
			                                         callFilter,
			...
			for (Map<String, Object> m : packages)
			{
				...
				catch(Exception ex)
				{
					...
					logging.warning(this, "retrieveProductsAllDepots exception for product2versionInfo2infos: of size " + product2versionInfo2infos.size()); 
					logging.warning(this, "retrieveProductsAllDepots exception for product2versionInfo2infos.get(p.getProductId()) " 
	...
	protected void retrieveAllProductPropertyDefinitions()
	{
		...
		if (depot2Product2PropertyDefinitions == null)
		{
			...
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " product property");
	...
	protected void retrieveAllProductDependencies()
	{
		...
		if (depot2product2dependencyInfos == null)
		{
			...
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " product dependency"); 
				
			String[] callAttributes = new String[]{};
			HashMap callFilter = new HashMap();

			java.util.List<Map<String, Object>>  retrievedList = persist.retrieveListOfMapsNOM(
			            callAttributes,
			            callFilter,
			...
			java.util.Set<String> hosts)
	{
		...
		else 
		{
			...
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " product property state");
			...
			result = persist.retrieveListOfMapsNOM(
					callAttributes,
					callFilter,
	...
	protected void retrieveInstalledSoftwareInformation()
	{
		if ( installedSoftwareInformation  == null || name2SWIdents == null )
		{
			...
			List<Map<String, Object>> li =  persist.retrieveListOfMapsNOM(
										 callAttributes,
										 callFilter,
			...
			while (iter.hasNext())
			{
				...
				if ( showForLicensing )
				{
					...
					*/
					...
					if (name2SWIdents.get( swName ) == null) name2SWIdents.put( swName,  new TreeSet<String>());
...
//===================================================
	...
	*/
	...
	protected void retrieveSoftwareAuditOnClients(final java.util.List<String> clients)
	{
		...
		if (client2software == null || softwareIdent2clients == null || newClients.size() > 0)
		{
			...
			while (newClients.size() > 0)
			{
				...
				persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " software config, step " + step);
				...
				if (newClients != null) callFilter.put("clientId",  persist.exec.jsonArray(clientListForCall));
				
				java.util.List <Map<String, Object>> softwareAuditOnClients
				= persist.retrieveListOfMapsNOM(
					 callAttributes,
					 callFilter,
	...
	//AUDIT_SOFTWARE_TO_LICENSE_POOL
	{
		...
		persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " AUDIT_SOFTWARE_TO_LICENSE_POOL");
	...
	protected void retrieveLicencepools()
	{
		...
		if (persist.withLicenceManagement)
		{
			...
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " licence pool");
	...
	//LICENSE_CONTRACT 
	{
		...
		if (persist.withLicenceManagement)
		{
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " software license");
	...
	//SOFTWARE_LICENSE_TO_LICENSE_POOL
	{
		...
		if (persist.withLicenceManagement)
		{
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " software_license_TO_license_pool");
	...
	//LICENSE_ON_CLIENT
	{
		...
		if (persist.withLicenceManagement)
		{
			persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " license_on_client");
	...
	//LICENSE_POOL
	{
		...
		persist.notifyDataLoadingObservers(configed.getResourceValue("LoadingObserver.loadtable") + " PRODUCT_ID_TO_LICENSE_POOL");
