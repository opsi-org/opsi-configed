...
class TestTest {
  ...
  private static final String FILENAME_VALID_LOCALISATIONS =
    "valid_localisations.conf";
  ...
  void testIfEverythingTranslated() {
    ...
    InputStream is =
      Messages.class.getResourceAsStream(FILENAME_VALID_LOCALISATIONS);
    ...
    try {
      ...
      assertTrue(
        false,
        "cannot load file with valid localisations: " +
        FILENAME_VALID_LOCALISATIONS
      );
    }
  ...
  void compareTwoLocals(String first, String second) {
    ...
    InputStream firstInputStream =
      Messages.class.getResourceAsStream(firstFileName);
    InputStream secondInputStream =
      Messages.class.getResourceAsStream(secondFileName);
